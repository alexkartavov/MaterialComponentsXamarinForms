...
{
    public class MaterialButtonRenderer : ViewRenderer<Button, MDCButton>
    {
        ...
        public SizeF SizeThatFits(SizeF size)
        {
            ...
            return new SizeF((float)result.Width, (float)result.Height);
        }
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Button> e)
        {
            ...
            if (e.NewElement != null)
            {
                if (Control == null)
                {
                    ...
                    _useLegacyColorManagement = false;//e.NewElement.UseLegacyColorManagement();
        ...
        void ComputeEdgeInsets(UIButton button, Button.ButtonContentLayout layout)
        {
            ...
            if (_titleChanged)
            {
                ...
                var s = stringToMeasure.GetSizeUsingAttributes(attribs);;
                _titleSize = new SizeF((float)s.Width, (float)s.Height);
                _titleChanged = false;
            }
