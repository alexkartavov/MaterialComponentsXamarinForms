...
{
    public class XfMaterialActivityIndicator: ActivityIndicator
    {
        public XfMaterialActivityIndicator()
        {
        }
        ...
        public static readonly BindableProperty RadiusProperty =
            BindableProperty.Create("Raduis", typeof(double));
        ...
        public static readonly BindableProperty StrokeWidthProperty =
            BindableProperty.Create("StrokeWidth", typeof(double));
        ...
        public static readonly BindableProperty TrackEnabledProperty =
            BindableProperty.Create("TrackEnabled", typeof(bool));
        ...
        public static readonly BindableProperty CycleColorsProperty =
            BindableProperty.Create("CycleColors", typeof(Color[]));
